...
export const COURSE_CATEGORIES: CourseCategory[] = [
  {
    ...
    courses: [
      { name: "Basic Health & Safety", duration: "1 Day", price: "R650", popular: true },
      ...
      { name: "Occupational Health & Safety (OHS) Act", duration: "1 Day", price: "R650", popular: true },
      { name: "OHS Act Advanced Legislation", duration: "1 Day", price: null },
      { name: "Risk Assessment (HIRA)", duration: "1 Day", price: "R700", popular: true },
      { name: "Apply Health & Safety to a Work Area", duration: "1 Day", price: "R700" },
      { name: "Accident & Incident Investigation", duration: "1 Day", price: "R700", popular: true },
      ...
      { name: "Construction Supervisor Course", duration: "1 Day", price: null, popular: true },
      ...
      { name: "Safety Officer Skills Programme", duration: "10 Days", price: "R7900", popular: true },
  ...
  },
  {
    ...
    courses: [
      ...
      { name: "Scaffolding Inspector", duration: "1 Day", price: "R700" },
  ...
  },
  {
    ...
    courses: [
      ...
      { name: "First Aid Level 2", duration: "1 Day", price: "R650" },
      { name: "First Aid Level 3", duration: "1 Day", price: "R650" },
      { name: "Emergency Evacuation Procedures", duration: "1 Day", price: "R650" },
      { name: "Basic Fire Awareness", duration: "1 Day", price: "R650" },
      { name: "Basic Firefighting", duration: "1 Day", price: "R650" },
  ...
  },
  {
    ...
    courses: [
      { name: "Forklift Operator", duration: "To Quote", price: null, popular: true },
